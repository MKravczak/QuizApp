...
import com.example.flashcardservice.service.QuizService;
...
public class QuizController {
    ...
    public ResponseEntity<List<QuizDto>> getQuizzesForDeck(
            @PathVariable Long deckId,
            @RequestHeader("X-User-ID") Long userId) {
        List<QuizDto> quizzes = quizService.getQuizzesForDeck(deckId, userId);
        return ResponseEntity.ok(quizzes);
    }
    ...
    public ResponseEntity<List<QuizQuestionDto>> generateQuizQuestions(
            @PathVariable Long quizId,
            @RequestHeader("X-User-ID") Long userId) {
        List<QuizQuestionDto> questions = quizService.generateQuizQuestions(quizId, userId);
